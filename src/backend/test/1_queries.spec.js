...
describe('Queries unit testing', _ => {
  ...
  describe('Database seed queries', _ => {
    describe('generateDeck()' , _ => {
      it('generates a deck for a game given gameId', asyncHOF(async () => {
    ...
    describe('generateHand()' , _ => {
      it('generates a hand for player given gameId and playerId', asyncHOF(async () => {
    ...
    describe('customHand()', _ => {
      it('gives a player a hand with special cards used for testing', asyncHOF(async () => {
    ...
    describe('setFirstCardInPlay()' , _ => {
      it('sets a random card in play for a game given gameId', asyncHOF(async () => {
  ...
  describe('addUser()' , _ => {
    it('adds a user with hashed password to database given name and password', asyncHOF(async () => {
  ...
  describe('getUsers()' , _ => {
    it('gets a list of users', asyncHOF(async () => {
  ...
  describe('findUser()' , _ => {
    it('finds a user based on name', asyncHOF(async () => {
  ...
  describe('getGames()' , _ => {
    it('gets a list of games', asyncHOF(async () => {
  ...
  describe('findGame()' , _ => {
    it('finds a game based on id', asyncHOF(async () => {
  ...
  describe('createGame()' , _ => {
    it('adds a game to the database specifying botfill', asyncHOF(async () => {
  ...
  describe('removeGame()' , _ => {
    it('should delete a game', asyncHOF(async () => {
      const result = await queries.removeGame({gameId: 1});
      result[0].should.equal(1);
    }))
  })
  describe('fillBots()' , _ => {
    it('fills a game with bots given gameId', asyncHOF(async () => {
  ...
  describe('setHost()' , _ => {
    it('Sets a host given a name', asyncHOF(async () => {
  ...
  describe('setTurn()' , _ => {
    it('Sets turn_id of game given a gameId and playerId', asyncHOF(async () => {
  ...
  describe('addPlayer()' , _ => {
    it('Adds a player to the database given gameId and name', asyncHOF(async () => {
  ...
  describe('updatePlayerCount()' , _ => {
    it('will update games player count given gameId and num', asyncHOF(async () => {
  ...
  describe('replacePlayer()' , _ => {
    it('will replace user_name of player given a playerId and name', asyncHOF(async () => {
  ...
  describe('getPlayer()' , _ => {
    it('returns a player given playerId', asyncHOF(async () => {
  ...
  describe('findPlayer()' , _ => {
    it('finds a player based on name', asyncHOF(async () => {
  ...
  describe('getDeck()' , _ => {
    it('returns a deck of cards given gameId', asyncHOF(async () => {
  ...
  describe('getHand()' , _ => {
    it('returns a hand of cards given playerId', asyncHOF(async () => {
  ...
  describe('removeCardInPlay()' , _ => {
    it('removes card from play given gameId', asyncHOF(async () => {
  ...
  describe('getCardInPlay()' , _ => {
    it('returns card in play for a game given gameId', asyncHOF(async () => {
  ...
  describe('getNextTurn()' , _ => {
    it('returns next turn based given gameId, currentTurnId, and isSkip boolean', asyncHOF(async () => {
      const game = await queries.findGame({gameId: 1});
      const nextTurn = await queries.getNextTurn({gameId: 1, currentTurnId: game.turn_id, isSkip: false});
      nextTurn.id.should.be.a('number');
    }));
  });

  describe('nextTurn()' , _ => {
    it('sets the nextTurn given gameId and isSkip boolean', asyncHOF(async () => {
  ...
  describe('flipDirection()' , _ => {
    it('flips the direction of game given gameId', asyncHOF(async () => {
      const game = await queries.findGame({gameId: 1});
  ...
  describe('giveCards()' , _ => {
    it('gives next player amount of cards given gameId and number of cards', asyncHOF(async () => {
  ...
  describe('drawCard()' , _ => {
    it('adds a card to players hand given gameId and playerId', asyncHOF(async () => {
