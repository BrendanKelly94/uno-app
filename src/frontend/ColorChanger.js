  ...
  return(
    <React.Fragment>
      <div style = {containerStyle} ref = {containerRef}>
        {colors.map((color) =>
          <div key = {color} id = {color} onClick = {() => changeColor(color)} onMouseEnter = {mouseEnter} onMouseLeave = {mouseLeave} style = {{...selectionStyle, backgroundColor: colorEnum[color]}}></div>
        )}
      </div>
