      ...
      <div style = {baseContainerStyle}>
        ...
        <div style = {homeContainerStyle}>
          ...
          <div style = {svgContainerStyle}>
            <svg height = '1em' width = '1em'> <circle r = '.5em' cx = {'50%'} cy = {'50%'} fill = {colorEnum['red']}/></svg>
            <svg height = '1em' width = '1em'><circle r = '.5em' cx = {'50%'} cy = {'50%'} fill = {colorEnum['yellow']}/></svg>
            <svg height = '1em' width = '1em'><circle r = '.5em' cx = {'50%'} cy = {'50%'} fill = {colorEnum['blue']}/>></svg>
            <svg height = '1em' width = '1em'><circle r = '.5em' cx = {'50%'} cy = {'50%'} fill = {colorEnum['green']}/></svg>
          </div>
